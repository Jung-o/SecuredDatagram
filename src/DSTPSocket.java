...
public class DSTPSocket {
    ...
    public DSTPSocket(int port, Key encryptionKey, Key macKey, Cipher cipher, Mac mac) throws Exception {
    ...
    public void send(byte[] data, InetAddress address, int port) throws Exception {
        DSTPPacket packet = new DSTPPacket(data, encryptionKey, macKey, cipher, mac);
    ...
    public byte[] receive() throws Exception {
        ...
        return DSTPPacket.decryptPacket(receivedData, encryptionKey, macKey, cipher, mac);
    }
